...
namespace BookShopTests.TagHelpers
{
    ...
    public class EmailTagHelperTests
    {
        ...
        public void Generates_Email_Link()
        {
            ...
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "test@bookshop.com", Content = "Email" };
            ...
            Assert.Equal("mailto:test@bookshop.com", tagHelperOutput.Attributes[0].Value);
        }
    }
}
